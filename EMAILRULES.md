...
```bash
gog -a pandajiban331@gmail.com gmail search 'in:inbox is:unread' --json
gog -a pandajiban331@gmail.com gmail search 'in:inbox newer_than:3d' --json
gog -a pandajiban331@gmail.com gmail search 'in:inbox (security OR vulnerability OR GHSA OR CVE OR incident)' --json
gog -a pandajiban331@gmail.com gmail search 'in:inbox from:notifications@github.com' --json
```

Follow-up:

```bash
gog -a pandajiban331@gmail.com gmail get <message-id> --json
gog -a pandajiban331@gmail.com gmail thread get <thread-id> --json
```
